...
?>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
<h1> Selamat Datang SIK Studio Akibaza , <?=$_SESSION['nama']?></h1>
...
<?php require 'user.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="export-semua.php" class="d-none d-sm-inline-block btn btn-sm btn-dark shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Download Laporan</a>
          </div>
...
if (isset($pemasukan_hari_ini['0'])) {
    $formattedValue = number_format($pemasukan_hari_ini['0'], 2, ',', '.');
    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp.' . $formattedValue . '</div>';
} else {
    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp.0.00</div>'; // Atau pesan default jika nilai tidak ada atau null.
}
?>
                    </div>
                    <div class="col-auto">
...
if (isset($pengeluaran_hari_ini['0'])) {
    $formattedValue = number_format($pengeluaran_hari_ini['0'], 2, ',', '.');
    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp.' . $formattedValue . '</div>';
} else {
    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp.0.00</div>'; // Atau pesan default jika nilai tidak ada atau null.
}
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-dark shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Karyawan</div>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Pendapatan Minggu Ini</h6>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Perbandingan</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
